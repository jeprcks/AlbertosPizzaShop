...
use App\Http\Controllers\Transaction\WEB\CancelledTransactionController;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/transaction/{transaction}/edit', [TransactionWEBController::class, 'edit'])->name('transaction.edit');
    Route::put('/transaction/{transaction}', [TransactionWEBController::class, 'update'])->name('transaction.update');
    Route::post('/transaction/{id}/cancel', [TransactionWEBController::class, 'cancel'])->name('transaction.cancel');

    // Logout
    Route::get('/admin/logout', [AdminAuthController::class, 'logout'])->name('admin.logout');

    // Cancelled Transactions
    Route::get('/cancelled-transactions', [CancelledTransactionController::class, 'index'])->name('cancelled-transactions.index');
});
